...
\newcommand\HorizUpCurve{{\frown}}
\newcommand\HorizDownCurve{{\smile}}
\newcommand\VertLeftCurve{{)}}
\newcommand\VertRightCurve{{(}}
\newcommand\Curves{A}
...
See \cite{dean} for this notation.
...
$(a, b)$ - An ordered pair. Also representable as a set \cite{suppes}: \\
...
$\Curves = \left\{  \VertLeftCurve, \VertRightCurve, \HorizUpCurve, \HorizDownCurve  \right\}$

\section{Shape and Colour}

$\SquareShape + \Blue = {\color{blue} \blacksquare}$ \\
${\color{blue} \blacksquare} - \Blue = \SquareShape$ \\
$\CircleShape + \Red = $ {\color{red} \ding{108}} \\
{\color{red} \ding{108}} $ - \Red = \CircleShape$
...
Godel Numbering, named after Austrian mathematician Kurt Godel, is the encoding of mathematical statements into numbers by some arbitrary scheme. The scheme used here is derived from that used by Douglas Hofstadter in "Godel, Escher, Bach: an Eternal Golden Braid" \cite{hofstadter}.
...
Saville colouring, named here after British graphic designer Peter Saville, is the encoding of numeric or textual information into arbitrary sequences of colours. Such a scheme was used by Saville on a number of record covers for Factory Records in the 1980s \cite{saville}, with the key being placed on the back cover of New Order's "Power, Corruption and Lies", 1983.

The colours Saville used to represent the numbers 1..9 are (in CMYK):
...
A more generic colour scheme would be:
...
\begin{thebibliography}{hofstadter9999}
  \bibitem[Dean]{dean} Neville Dean.
    \emph{The Essence Of Computing: Discrete mathematics.}
    Prentice Hall, London, 1997.
  \bibitem[Hofstadter]{hofstadter} Douglas R. Hofstadter.
    \emph{Godel, Escher, Bach: an Eternal Golden Braid.}
    20th Anniversary Edition.
    Penguin Books Ltd., London, 2000.
  \bibitem[Saville]{saville} Peter Saville.
    \emph{Annotated artwork for the New Order album 
          ``Power Corruption and Lies''.}
    Creative Review, January 2003 (Front Cover).
  \bibitem[Suppes]{suppes} Patrick Suppes.
